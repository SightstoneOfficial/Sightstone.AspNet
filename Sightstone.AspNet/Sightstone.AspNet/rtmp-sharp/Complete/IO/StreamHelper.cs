...
namespace Complete.IO
{
    class StreamHelper
    {
        public byte[] ReadBytes(this Stream stream, int count)
        {
            if (stream == null)
        ...
        public async Task<byte[]> ReadBytesAsync(this Stream stream, int count)
        {
            if (stream == null)
                throw new ArgumentNullException("stream");
        ...
        public async Task<byte> ReadByteAsync(this Stream stream)
        {
