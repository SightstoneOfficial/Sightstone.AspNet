...
namespace Complete
{
    ...
    class MethodFactory
    {
        ...
        readonly ConcurrentDictionary<object, ConstructorCall> ConstructorCache = new ConcurrentDictionary<object, ConstructorCall>();
        readonly ConcurrentDictionary<object, MethodCall> MethodCache = new ConcurrentDictionary<object, MethodCall>();
        ...
        ExpressionArgsPair GetObjectCreatorExpressions(ConstructorInfo constructor)
        {
        ...
        public ConstructorCall CompileObjectConstructor(ConstructorInfo constructor)
        {
        ...
        public ConstructorCall CompileBoxedObjectConstructor(ConstructorInfo constructor)
        {
            var expressions = GetObjectCreatorExpressions(constructor);
        ...
        ExpressionArgsPair GetMethodCallExpressions(MethodInfo method)
        {
            // create a single param of type object[]
            ...
            // call method with args
            var callInstance = method.Is? null : instance;
        ...
        public MethodCall CompileMethodCall(MethodInfo method)
        {
        ...
        // does the same as `CompileObjectConstructor`, but with an extra boxing expression
        public MethodCall CompileBoxedMethodCall(MethodInfo method)
        {
            var expressions = GetMethodCallExpressions(method);
            var conversion = Expression.Convert(expressions.Expression, typeof(object));
        ...
        public T CallMethod<T>(MethodInfo method, object instance, object[] arguments)
        {
            return (T)CallMethod(method, instance, arguments);
        }
        public object CallMethod(MethodInfo method, object instance, object[] arguments)
        {
        ...
        private Expression[] GetMethodCallArgsExpressions(ParameterInfo[] parameters, ParameterExpression args)
        {
