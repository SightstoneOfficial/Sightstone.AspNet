...
namespace RtmpSharp.Net
{
    struct RtmpHandshake
    {
        ...
        public async Task<RtmpHandshake> ReadAsync(Stream stream, bool readVersion)
        {
        ...
        public Task WriteAsync(Stream stream, RtmpHandshake h, bool writeVersion)
        {
        ...
        public Task WriteAsync(Stream stream, RtmpHandshake h, RtmpHandshake h2, bool writeVersion)
        {
            using (var memoryStream = new MemoryStream())
            using (var writer = new AmfWriter(memoryStream, null))
            {
